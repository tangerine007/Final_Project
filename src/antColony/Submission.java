...
public class Submission {
	...
	public static void main(String[] args) {
		...
		//MAP_INFO - info about spawning the map
			...
			int mapHeight=200;//the map will be populated with this many cells on the Y-axis
		...
		//COLONY_INFO - info about the way that the algorithm operates
			//start_location - where the ants will start their journey from
				int startX=mapWidth/2;//the X-axis location of start
				int startY=mapHeight/2;//the Y-axis location of start
			...
			int releaseValue=1;//After how many "time periods"/"moves" should another ant be released onto the map
		...
		map.antColony(terminateValue,releaseValue,start,pheromoneRelease);//runs the ant colony optimization algorithm for given parameters
