...
public class Submission {
	...
	public static void main(String[] args) {
		...
		//COLONY_INFO - info about the way that the algorithm operates
			...
			int releaseValue=100;//After how many "time periods"/"moves" should another ant be released onto the map
			int pheromoneRelease=1000;//On its way back to the colony, how many pheromones does an ant release in each cell
			int specialAntMultiplier=5;//multiplies the number of pheromones released by this value for ants that make a shorter trip
